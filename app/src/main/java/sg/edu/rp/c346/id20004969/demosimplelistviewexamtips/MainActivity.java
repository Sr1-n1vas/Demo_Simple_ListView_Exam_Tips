package sg.edu.rp.c346.id20004969.demosimplelistviewexamtips;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        examTipsArray[4] = "Create a few empty Android projects to speed up your coding during the exam";
    }
}